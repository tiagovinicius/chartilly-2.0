...
export default function Top50Page(){
  ...
  function removeConfirmFlag(){
    try{
      ...
      if (url.searchParams.has('confirm')){
        ...
        window.history.replaceState({}, '', next || '/charts/top50');
      }
    }catch{}
  }
  ...
  <h1 id="title" className="mt-4 text-2xl md:text-3xl font-bold text-center pb-4 text-[hsl(var(--secondary-foreground))]">Weekly Top 50</h1>
